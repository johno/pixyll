...
{% include wrap_image.html subfolder=page.subfolder src="/VimAdventures.jpg" %}
...
{% include wrap_image.html date=page.subfolder src="/VimPackages.png" %}
...
{% include wrap_image.html date=page.subfolder src="/Emacs.png" %}
